...
class DotIndicatorDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    private val selectedColor: Int = androidx.core.content.ContextCompat.getColor(context, com.matteopasotti.whatmovie.R.color.violet)
    private val unselectedColor: Int = androidx.core.content.ContextCompat.getColor(context, com.matteopasotti.whatmovie.R.color.grey)
